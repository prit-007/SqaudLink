...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-zinc-950 via-zinc-900 to-purple-950/20">
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        {/* Navigation Header */}
        <nav className="sticky top-0 z-50 backdrop-blur-xl bg-zinc-900/50 border-b border-white/5 safe-area-pt">
          <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
            <div className="flex items-center justify-between h-14 md:h-16">
              <div className="flex items-center gap-2 md:gap-3 min-w-0 flex-1">
                <div className="p-1.5 md:p-2 bg-gradient-to-br from-purple-500/20 to-teal-500/20 rounded-xl md:rounded-2xl backdrop-blur-sm border border-white/10 flex-shrink-0">
                ...
                <h1 className="text-lg md:text-xl font-bold bg-gradient-to-r from-purple-400 to-teal-400 bg-clip-text text-transparent truncate">
                  Squad Link
                </h1>
              </div>
              ...
              <div className="flex items-center gap-2 md:gap-4 flex-shrink-0">
                {profile && (
                  <div className="flex items-center gap-2 md:gap-3 min-w-0">
                    <img 
                      ...
                      className="w-8 h-8 md:w-10 md:h-10 rounded-full border-2 border-purple-500/30 flex-shrink-0"
                    />
                ...
                <button
                  ...
                  className="px-3 md:px-4 py-2 rounded-lg md:rounded-xl bg-white/5 hover:bg-white/10 active:scale-95 border border-white/10 text-xs md:text-sm font-medium text-white transition-all"
                >
        ...
        <main className="flex-1 flex items-center justify-center px-4 py-8 md:py-12">
          <div className="max-w-4xl w-full">
            ...
            <div className="text-center mb-8 md:mb-12 space-y-4 md:space-y-6">
              <div className="inline-block p-4 md:p-6 bg-gradient-to-br from-purple-500/10 to-teal-500/10 rounded-3xl md:rounded-[2rem] backdrop-blur-xl border border-white/10 mb-4 md:mb-6 animate-pulse-glow">
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold bg-gradient-to-r from-purple-400 via-pink-400 to-teal-400 bg-clip-text text-transparent mb-3 md:mb-4 px-4">
            ...
            <div className="text-center p-8 bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-xl border border-white/10 rounded-3xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button 
                  ...
                  className="px-8 py-3.5 rounded-2xl bg-gradient-to-r from-purple-600 via-purple-500 to-indigo-600 hover:from-purple-500 hover:via-purple-400 hover:to-indigo-500 text-white font-semibold shadow-xl shadow-purple-500/30 transition-all hover:scale-[1.02] active:scale-[0.98]"
                >
                  💬 Start Chatting
                </button>
